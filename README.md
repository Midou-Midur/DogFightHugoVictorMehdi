...
il a la charge du stockage de toutes les données du projet, la position de avions, des nuages, des missiles, leur direction, la taille du ciel, ... Il est le seul à disposer de ces informations, par contre, il produit une interface (IDogfightModel) permettant aux composants extérieurs de lui poser des questions ou de lui donner des ordres. Il produit aussi un élément Observable permettant de savoir s'il a été modifé.
